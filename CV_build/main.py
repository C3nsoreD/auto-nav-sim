...
def canny_template(image):
    """
    Takes an image file 
    returns a canny version of the file.
...
def brightness_filter(gray):
    """
    Applies Gaussian, thresholding and Morphology on grey images 
...
if __name__ == "__main__":
    template = canny_template(cv.imread("images/templates/13.jpg"))
